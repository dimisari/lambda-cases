...
value_type_tuple_matching_err_msg =
  ("Trying to match tuple but got type: " ++) . show
  :: ValueType -> Error

value_types_tuple_matching_err_msg1 =
...
or_type_err_msg = "or_type of the same name already defined"
  :: Error

-- Values
vt_values_err_msg = ( \vs vt ->
