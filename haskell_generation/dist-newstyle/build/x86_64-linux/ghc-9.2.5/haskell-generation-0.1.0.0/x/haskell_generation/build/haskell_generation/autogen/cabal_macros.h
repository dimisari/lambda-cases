...
/* package haskell-generation-0.1.0.0 */
#ifndef VERSION_haskell_generation
#define VERSION_haskell_generation "0.1.0.0"
#endif /* VERSION_haskell_generation */
#ifndef MIN_VERSION_haskell_generation
#define MIN_VERSION_haskell_generation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_generation */
...
#define CURRENT_COMPONENT_ID "haskell-generation-0.1.0.0-inplace-haskell_generation"
