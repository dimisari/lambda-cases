...
<simple-expr> ::=  <simple-op-expr> | <simple-func-expr> | <simple-op-func-expr>  )
\end{grammar}
...
<arguments> ::= `(' <basic-or-simple-expr> ( `,\ ' <basic-or-simple-expr> )* `)'
...
\item \texttt{(WithIO)IsAnEnvironment} is a true statement
\end{itemize}
...
\\\\
An operator expression might have multiple operators
and therefore arguments between two operators. The order in which the operators
are going to act on the arguments is explained in the next section ("Complete
...
\begin{grammar}
<op-expr> ::=
<simple-op-expr> | <simple-op-func-expr> | <op-cases-func-expr> \\

<simple-op-expr> ::= <op-arg> `\ ' <op> `\ ' <op-arg>

<simple-op-func-expr> ::=
<op-arg> `\ ' <op> `\ ' ( <simple-op-func-expr> | <simple-func-expr> )

<op-cases-func-expr> ::=
<op-arg> `\ ' <op> `\ ' ( <op-cases-func-expr> | <cases-func-expr> )\\

<op-arg> ::= <basic-expr> | <paren-expr> | <simple-op-expr>
...
by a comma. The parameters and the body are seperated by an arrow (" \texttt{=>} ").
...
<simple-func-expr> ::=
<parameters> `\ =>\ ' ( <simple-op-expr> | <simple-op-func-expr> )
...
<case> ::=
`\\n' <indentation> <matching> ( `,\ ' <matching> )* `\ =>\ ' <op-expr>
