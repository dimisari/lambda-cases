...
\item \textit{Grammar}
\begin{grammar}
<tuple> ::= `(' <simple-expression> ( `,\ ' <simple-expression> )+ `)'
\end{grammar}
...
\item \textit{Grammar}
\begin{grammar}
<list> ::= `[' [<simple-expression> ( `,\ ' <simple-expression> )*] `]'
\end{grammar}
...
\begin{grammar}
<op-expr> ::=
<simple-op-expr> | <op-func-expr> \\

<simple-op-expr> ::= <op-arg> `\ ' <op> `\ ' <op-arg>

<op-func-expr> ::=
<op-arg> `\ ' <op> `\ ' ( <op-func-expr> | <func-expr> )\\

<op-arg> ::= 
<literal> | <identifier> | <tuple> | <list> | <paren-func-app> | <paren-expr> |
<simple-op-expr>
...
<paren-expr> ::=  
`(' ( <simple-op-expr> | <simple-func-expr> | <op-simple-func-expr>  ) `)'

<op-simple-func-expr> ::=
<op-arg> `\ ' <op> `\ ' ( <op-simple-func-expr> | <simple-func-expr> )
\end{grammar}
...
<arguments> ::= `(' <simple-expression> ( `,\ ' <simple-expression> )* `)'
...
\begin{grammar}
<func-expr> ::=
<simple-func-expr> | <cases-func-expr>\\

<simple-func-expr> ::= <parameters> `\ =>\ ' <op-expr> 
...
\paragraph{Grammar}
\begin{grammar}
<cases-func-expr> ::= <case-parameters> `\ =>\ ' <cases> \\
