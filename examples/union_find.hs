...
connected_components_of' =
  ...
  is :: State
  is =
    ft2(apply'to_all_in'((\pA0 -> ft2(pA0, Cis_repr((1 :: P.Integer)))), nodes(g)), length_of'(nodes(g)))
  ...
  find' =
    ...
    case pA0 of
      ...
      Chas_parent parent -> find'(parent)
  in
...
main :: Program
main =
  connected_components_of'(test_graph) &> (\pA0 -> print'(pA0))